...
public class UserTest {
    ...
    void testCreate(){
        //given
        User user = new User(name, username, email, Role.STUDENT, "xpto");
    ...
    void testCreateEqualUsers(){
        //given
        User user = new User(name, username, email, Role.STUDENT, "xpto");
        User user2 = new User("Mary", username, email, Role.ADMIN, "xpto");
    ...
    void testInvalidUsername(){
        ...
        Throwable inValidUsernameFormat = assertThrows(InvalidArgumentException.class, () -> {
            User user = new User(name, "12345", email, Role.STUDENT, "xpto");
        });
        //then
